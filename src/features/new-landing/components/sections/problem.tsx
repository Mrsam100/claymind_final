...
export default function Problem() {
  ...
  return (
    <section ref={ref} id="about" className="relative py-24 bg-white overflow-hidden">
      <motion.div style={{ opacity }} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div style={{ y }} className="relative rounded-3xl overflow-hidden shadow-2xl">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1771408427146-09be9a1d4535?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxraWRzJTIwbGVhcm5pbmclMjB0ZWNobm9sb2d5JTIwY2xhc3Nyb29tfGVufDF8fHx8MTc3Mjg5OTE3N3ww&ixlib=rb-4.1.0&q=80&w=1080"
