        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div style={{ scale }} className="relative">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1674049406486-4b1f6e1845fd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaGlsZHJlbiUyMGNvZGluZyUyMGNvbXB1dGVyfGVufDF8fHx8MTc3Mjg5OTE3OHww&ixlib=rb-4.1.0&q=80&w=1080"
          ...
          <div>
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">Hands-On Experience</h3>
